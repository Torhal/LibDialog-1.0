...
local function _BuildDialog(delegate, data)
    ...
    if not dialog then
        ...
        dialog.is_new = true
        -- no need to implicitly prevent closing in combat by using UIPanelCloseButton template 
        -- ESC closing doesn't check protected status anyway, make it behave consistently
